document.addEventListener("DOMContentLoaded", async () => {
    ...
    const [complaints, students, employees, departments, faculties] =
        await Promise.all([
    ...
    const renderTable = (data) => {
        ...
        tableBody.innerHTML = data
            ...
            <tr>
                <td>${c.id}</td>
                <td>${c.title}</td>
                <td><a href="student/view.html?id=${c.studentId}">${
                    c.studentName
                }</a></td>
                <td><a href="employee/view.html?id=${c.employeeId}">${
                    c.employeeName
                }</a></td>
                <td>${getStatusBadge(c.status)}</td>
                <td>${c.date}</td>
                <td><a <a href="complaint/view.html?id=${encodeURIComponent(
                    c.id
